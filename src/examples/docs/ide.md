...
以下内容除插件及编辑器设置需手动操作外，如果项目由天闻前端框架生成，所有项都会自动生成
...
作用： 设置项目的JS规范，如需添加忽略目录，请在根目录下添加.eslintignore文件
<br>
<br>
```
module.exports = {
...
## 项目根目录.stylelintrc.json文件
作用： 设置项目的CSS规范，如需添加忽略目录
<br>
<br>
```
{
